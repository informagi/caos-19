...
def evaluate_run(run, qrels):
    ...
    output = subprocess.check_output(
        f'C:/Users/Allemaal/Desktop/ubuntu/Desktop/anserini/tools/eval/trec_eval.9.0.4/trec_eval.exe -c -m ndcg_cut.10 -m recall.1000 -m map {qrels} runs/{run}', shell=True)
    ...
    output = subprocess.check_output(
        f'C:/Users/Allemaal/Desktop/ubuntu/Desktop/anserini/tools/eval/trec_eval.9.0.4/trec_eval.exe -c -m ndcg_cut.20 {qrels} runs/{run}', shell=True)
